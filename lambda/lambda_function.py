...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output = "Welcome to your skill! How can I assist you today? You can ask me to say hello, capture a zodiac sign"
        reprompt_output = "You can say, 'say hello', 'capture my zodiac sign'"
        return (
...
class CaptureZodiacSignIntentHandler(AbstractRequestHandler):
    """Handler for CaptureZodiacSignIntent."""
    def can_handle(self, handler_input):
    ...
    def handle(self, handler_input):
        ...
        # Fetching data from external source (Google Sheets CSV)
        ...
        # Generating response
        speak_output = f'Your zodiac sign is {zodiac}.'
        card_title = "Zodiac Sign"
        card_content = f"Your zodiac sign is {zodiac}."
...
class HelloWorldIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output = "Hello, world! This is your skill responding to the HelloWorldIntent."
        return (
            handler_input.response_builder
            .speak(speak_output)
            .response
